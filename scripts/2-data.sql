...
INSERT INTO tblTourInfo (name, pricePerPerson, maxSlot, duration, isOneTime, agentId)
...
INSERT INTO tblTourInfo (name, pricePerPerson, maxSlot, duration, isOneTime, agentId)
VALUES ('Hà Nội - Sapa - Bản Cát Cát - Fansipan - Cổng Trời Ô Quy Hồ', 45, 10, 4, 1, 3);

INSERT INTO tblDestination (name, content, `day`, cityId, tourInfoId)
...
INSERT INTO tblTour(departure, departureTime, tourInfoId, tourGuideId)
...
INSERT INTO tblBooking(totalPrice, customerId, tourId)
VALUES (100, 5, 1);

INSERT INTO tblBooking(totalPrice, customerId, tourId)
VALUES (50, 6, 1);

INSERT INTO tblVisitor(name, bookingId)
VALUES ('Duong Qua', 1);
